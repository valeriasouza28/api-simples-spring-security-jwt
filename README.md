...
3. Install [SQL](https://www.postgresql.org/)
...
## Database
The project utilizes [SQL](https://www.postgresql.org/) as the database. The necessary database migrations are managed using Flyway.
